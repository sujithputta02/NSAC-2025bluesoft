  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-space">
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <div className="inline-flex items-center justify-center gap-8 mb-8">
          <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
          {[
            ...
            <div
              key={index}
              className="group p-6 bg-card/10 backdrop-blur-md border border-primary/10 rounded-xl hover:bg-card/20 hover:border-primary/30 transition-all hover:scale-105 hover:shadow-glow animate-fade-in"
